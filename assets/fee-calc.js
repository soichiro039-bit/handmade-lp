/* =====================================================================
   ...
   値の正本: 07_開発移行/料率マスタ/fee_master_v0.json
   （このヘッダに版番号を書かない。下の data_version が唯一の版表示であり、2か所に書くと
     必ず片方が置き去りになる。実際 r49 まで進んだ後もここだけ r46 のまま残っていた
     ——2026-07-29 法務部）
   ===================================================================== */
(function (global) {
  "use strict";
  ...
  var META = {
    ...
    data_version: "2026-07-29-r50",
    channels: {
      minne: {
        name: "minne", rate: 0.10659, fixed: 0, rateText: "10.659%",
        asof: "2026-07-27", checked: "2026-07-29", rateConf: "primary",
